...
engine = create_engine('postgresql://postgres:Password1@localhost/ginzi_dev')
...
def init_db():
    ...
    steven = User(username='Steven', email='elishashestov@gmail.com', phone='+972545239086')
    ...
    # steven = User(username='Steven')
    # steven = User(username='Steven', email='elishashestov@gmail.com', phone='+972545239086', code='12345')
    # db_session.add(steven)
    # db_session.commit()